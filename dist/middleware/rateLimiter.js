...
const limiters = {
    login: new rate_limiter_flexible_1.RateLimiterMemory({ points: 5, duration: 60, blockDuration: 300 }),
    register: new rate_limiter_flexible_1.RateLimiterMemory({ points: 3, duration: 60 }),
    // Endpoints that send mail. Tight, because the cost of abuse lands on the
    // account owner's inbox and our sending reputation.
    sendMail: new rate_limiter_flexible_1.RateLimiterMemory({ points: 3, duration: 900 }),
    ...
    redeem: new rate_limiter_flexible_1.RateLimiterMemory({ points: 15, duration: 900 }),
    global: new rate_limiter_flexible_1.RateLimiterMemory({ points: 100, duration: 60 }),
};
/**
 ...
 */
const clientLimiter = new rate_limiter_flexible_1.RateLimiterMemory({ points: 600, duration: 60 });
